...
@app.route('/api/set_verdict_info')
...
@app.route('/api/set_verdict_description')
...
@app.route('/api/get_verdict_info')
...
@app.route('/api/get_all_verdicts')
...
@app.route('/api/delete_actus_reus')
...
@app.route('/api/add_natural_expression')
...
@app.route('/api/get_natural_expressions')
...
@app.route('/api/delete_natural_expression')
def delete_natural_expression():
    global al
    natural_expression_key = int(request.args.get('natural_expression_key'))
    verdict_key = int(request.args.get('verdict_key'))
    al.delete_natural_expression(natural_expression_key, verdict_key)
    return jsonify(result = "ok")

@app.route('/api/delete_verdict')
def delete_verdict():
    global al
    verdict_key = int(request.args.get('verdict_key'))
...
def search():
    ...
    for h in es_hits:
        ...
        v_actus_reus = al.get_actus_reus(v_key)
        results.append({
            "verdict_key": v_key,
            "score": v_key,
